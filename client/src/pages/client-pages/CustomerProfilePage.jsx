...
export default function CustomerProfilePage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Fetch user data
                const userResponse = await fetch(`${process.env.REACT_APP_BACKEND_HOST}/api/clients/${userId}`, {
                ...
                // Fetch orders
                const ordersResponse = await fetch(`${process.env.REACT_APP_BACKEND_HOST}/api/orders/client`, {
                    headers: { Authorization: `Bearer ${token}` },
                });
    ...
    const handleCancelOrder = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await fetch(`${process.env.REACT_APP_BACKEND_HOST}/api/orders/${selectedOrderId}/cancel`, {
                method: 'PATCH',
                headers: {
    ...
    const handleEditSubmit = async () => {
        try {
            const token = localStorage.getItem('token');
            const response = await fetch(`${process.env.REACT_APP_BACKEND_HOST}/api/clients/${userId}`, {
                method: 'PATCH',
                headers: {
                    Authorization: `Bearer ${token}`,
                    'Content-Type': 'application/json',
